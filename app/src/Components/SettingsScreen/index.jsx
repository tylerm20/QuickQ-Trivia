        ...
        <Modal showModal>
            <div className="Settings">
                <div>
                    ...
                    game, a question will begin to appear one character at a
                    time. If you think you know the answer to the question, hit
                    the "Buzz" button and type in your answer. Hitting the
                    "Buzz" button will stop new characters of the question from
